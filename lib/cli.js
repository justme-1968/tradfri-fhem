...
module.exports = function() {
  ...
  program
    ...
    .option('-s, --secret [secret]', 'the secret', function(s) { Tradfri.secret(s) })
    .option('-i, --identity [identity]', 'the identity', function(i) { Tradfri.identiy(s) })
    .option('-p, --psk [psk]', 'the psk', function(p) { Tradfri.psk(s) })
